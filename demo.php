...
<html lang="en">
  <head>
    ...
    <title>HMS - HR Management System</title>
    <!-- Favicon -->
	...
	<header id="mu-hero">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light mu-navbar">
				<!-- Text based logo -->
				<a class="navbar-brand mu-logo" href="index.html"><span><b>HMS</b></span></a>
				<!-- image based logo -->
			    ...
			    <ul class="navbar-nav mr-auto mu-navbar-nav">
				  ...
				  <li class="nav-item"><a href="pricing.html">Pricing</a></li>
			       <li class="nav-item dropdown">
					...
					<li class="nav-item active"><a href="demo.html">Request Demo</a></li>
			        <li class="nav-item"><a href="contact.html">Contact us</a></li>
					<li class="nav-item"><a href="signin.html">Signin</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-page-header-area">
						<h1 class="mu-page-header-title">Request Demo</h1>
					</div>
				</div>
			</div>
		</div>
...
<p>
See how HMS (HR Management System) can help your organization
manage employees, payroll, and HR processes efficiently.
...
<input type="email" id="business-email" class="form-control" placeholder="Enter your business email">
</div>
...
<div class="form-group">
<label>Message</label>
<textarea id="message" class="form-control" rows="5" placeholder="Tell us about your HR needs"></textarea>
</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="mu-call-to-action-area">
							...
							<a href="page" class="mu-primary-btn mu-quote-btn">Get a Quote <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="mu-pricing-area">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="mu-title">
										<h2>HMS Pricing Plans</h2>
										<p>Choose the plan that fits your organization's HR needs.</p>
									</div>
								</div>
								<div class="col-md-12">
										...
										<ul class="mu-pricing-table">
											<li>
												<div class="mu-pricing-single">
													...
													<a class="mu-buy-now-btn" href="signup.html">Get Started</a>
												</div>
											</li>
											<li class="mu-standard-pricing">
												<div class="mu-pricing-single">
													...
													<a class="mu-buy-now-btn" href="signup.html">Start Free Trial</a>
												</div>
											</li>
											<li>
												<div class="mu-pricing-single">
													...
													<div class="mu-pricing-single-content">
														<ul>
															...
															<li>Advanced HR Reports</li>
															<li>Priority Support</li>
														</ul>
													</div>
													<div class="mu-single-pricebox">
														<h4>79$<span>/month</span></h4>
													</div>
													<a class="mu-buy-now-btn" href="demo.html">Request Demo</a>
												</div>
											</li>
										</ul>
									</div>
							...
							<div class="mu-testimonials-block">
								<ul class="mu-testimonial-slide">
									...
									<li>
										...
										<p>Working with this HR Management System has made development workflows much smoother. The system is well-structured, scalable, and integrates easily with other tools, making it a reliable solution for modern organizations.</p>
									...
									<li>
										...
										<p>I’m impressed with how intuitive and user-friendly the HR platform is. The clean interface and thoughtful design make it easy for both employees and HR managers to navigate and complete tasks efficiently."</p>
									...
									<li>
										...
										<p>"The design and layout of this HR system are modern, responsive, and visually appealing. It perfectly balances aesthetics with functionality, creating a seamless experience across all devices."</p>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="mu-single-footer">
							...
							<p>HMS is a modern Human Resource Management System designed to simplify workforce management. From employee records and attendance tracking to payroll and analytics, our platform helps organizations manage their HR operations efficiently and effectively. </p>
						...
						<div class="mu-single-footer">
							...
							<ul class="list-unstyled">
							  	<li class="media">
								   <span class="fa fa-twitter"></span>
								    <div class="media-body">
								    	<p><strong>@HMS</strong> Visit Our Twitter Handle.</p>
							  	...
							  	<li class="media">
								   	<span class="fa fa-twitter"></span>
								    <div class="media-body">
								    	<p><strong>@HMS</strong> More About Our HMS Website</p>
								    	<a href="#">2 hours ago</a>
								    </div>
							  	</li>
							</ul>
